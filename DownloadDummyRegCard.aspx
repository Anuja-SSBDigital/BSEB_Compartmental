                    ...
                    <div class="table-responsive">
                        <asp:Panel ID="pnlStudentTable" runat="server" Visible="false">
                            <table class="table table-hover table-bordered dataTable" id="dataTable">
                                ...
                                <tbody id="tableBody">
                                    <asp:Repeater runat="server" ID="rptStudents" EnableViewState="true" ClientIDMode="Static" OnItemDataBound="rptStudents_ItemDataBound">
                                        <ItemTemplate>
                                            <tr data-visible="true">
                                                ...
                                                <td>
                                                    <asp:Panel ID="pnlUploadControls" runat="server"
                                                        ...
                                                        <asp:Button ID="btnUploadRow" runat="server" Text="Upload"
                                                            CssClass="btn btn-sm btn-info"
                                                            CommandArgument='<%# Eval("StudentID") %>'
                                                            OnClick="btnUpload_Click" />
                                                    </asp:Panel>

                                                    <asp:HiddenField runat="server" ID="hf_IsRegCardUploaded"
                                                        Value='<%# Eval("IsRegCardUploaded") %>' />
                                                    <a runat="server" visible="false" id="divpath" href='<%# Eval("RegCardPath") %>'
