<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ExmChallanRecall.aspx.cs" Inherits="ExmChallanRecall" MasterPageFile="~/MasterPage.master" %>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h4>Exam Challan Recall Data</h4>
                </div>
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="collegeCode" class="form-label required">+2 School Code & Name </label>
