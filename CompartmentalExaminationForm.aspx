<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CompartmentalExaminationForm.aspx.cs" Inherits="CompartmentalExaminationForm" %>
...
<body>
    <form id="form1" runat="server">
        <div class="print-btn-container" style="text-align: center !important; margin-bottom: 10px;">
            ...
            <a href="DwnldCompartMentalExamForm.aspx" class="btn btn-primary no-print" id="btnback" style="text-decoration: none !important;">Back</a>
                        ...
                        <div class="page" id="page1">
                            <div class="form-header">
                                ...
                                <div class="hindi-line">
                                    <%--<strong>Online Examination Application Form for Intermediate <asp:Label ID="lblExamTitle" runat="server"/> Examination, 2026--%>
                                    <strong>Online Examination Application Form for Intermediate Special Examination, 2026
