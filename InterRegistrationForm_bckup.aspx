<%@ Page Language="C#" AutoEventWireup="true" CodeFile="InterRegistrationForm.aspx.cs" Inherits="InterRegistrationForm" %>
...
*/ padding: 8px 12px;
        ...
        #pagewrap .signature-row, #pagewrap .principal-section {
            display: flex;
            justify-content: space-between;
            margin-top: 30px;
        }

        #pagewrap .signature-box, #pagewrap .principal-box {
            width: 200px;
            height: 50px;
...
<body>
    <form id="form1" runat="server">
        <div class="print-btn-container" style="text-align: center !important; margin-bottom: 10px;">
            <a href="dwnldregform.aspx" id="btnback" class="btn mb-3">Back</a>

            <asp:Button ID="btnPrint" CssClass="btn" runat="server" Text="Download PDF" OnClientClick="updateAndPrint(); return false;" />
        ...
        <asp:Repeater ID="rptStudents" runat="server" OnItemDataBound="rptStudents_ItemDataBound">
            <ItemTemplate>
                ...
                <div class="container" id="pagewrap">
                    ...
                    <%-- <div class="lineheart_a page" id="page1">
                        <div class="form-header" style="margin-top: 40px;">
                            <div class="board-title">BIHAR SCHOOL EXAMINATION BOARD</div>
                            <div class="exam-title">REGISTRATION FORM</div>
                            <div class="board-title">Intermediate Examination, 2027</div>
                            <div class="board-title">
                                SESSION-2025-27
                            </div>
                            <div class="form-container" style="height: 750px; font-size: larger; font-weight: 100;">
                                <center>
                                    <p><u>सूचीकरण आवेदन पत्र भरे जाने के संबंध में आवश्यक निर्देश</u></p>
                                </center>
                                <div class="section-header">(क)<i> पूर्व से भरा हुआ (Prefilled) सूचीकरण/अनुमति आवेदन के साथ घोषणा पत्र भरने के संबंध में निदेश :-</i></div>

                                <!-- Notes -->
                                <div>
                                    <p>(i) ऑनलाइन सूचीकरण/अनुमति आवेदन भरने के क्रम में प्रविष्ट विवरणों की परिशुद्धता के सत्यापन हेतु विद्यार्थी व माता/पिता/अभिभावक के हस्ताक्षरित घोषणा पत्र विद्यालय प्रधान के हस्ताक्षर एवं मुहर के साथ समिति के पोर्टल पर अनिवार्य रूप से अपलोड किया जाएगा।</p>

                                </div>

                                <div class="section-header3">(ख) अन्य निर्देश :-</div>
                                <!-- Notes -->
                                <div>
                                    (i). विद्यार्थी द्वारा आवेदन पत्र के विहित स्तंभ में अपना वैध (Valid) मोबाईल नं० एवं ई-मेल आई०डी० ही अंकित किया जाए।
                                    <br />

                                    (ii). एक मोबाइल नं० का उपयोग एक ही विद्यार्थी के सूचीकरण आवेदन पत्र भरने हेतु किया जा सकता है।<br />

                                    (iii). आवेदन पत्र के क्रम संख्या 20, 30, 31 एवं 32 को छोड़कर सभी विवरणों को भरा जाना अनिवार्य (Compulsory) है।
                    ...
                    <div class="lineheart_a">
                        <div class="form-container page" id="page1" style="margin-top: 40px;">
                            <div class="form-header" style="margin-top: 40px;">
                                <div class="board-title">BIHAR SCHOOL EXAMINATION BOARD</div>
                            ...
                            <div class="hindi-line">
                                इन्टरमीडिएट कक्षा में सत्र 2025-27 में मान्यता प्राप्त शिक्षण संस्थानों में नामांकित विद्यार्थी के लिए                           
                            </div>
                            ...
                            <!-- Notes -->
                            <div class="note-box">
                                <b>नोट:</b> i) OFSS प्रणाली से नामांकन हेतु आपके द्वारा दी गई सूचनाओं के आधार पर आपका नामांकन विवरण इस प्रपत्र के खंड 'A' (क्रमांक–1 से 17) में अंकित है।<br />
                                (ii) खंड 'A' (क्रमांक–1 से 17) में अंकित विवरणों में विद्यार्थी द्वारा किसी भी प्रकार का कोई छेड़-छाड़/परिवर्तन नहीं किया जाएगा। अर्थात् क्रमांक–1 से 17 तक में विद्यार्थी द्वारा कुछ भी नहीं लिखा जाएगा।<br />
                                (iii)विद्यार्थी द्वारा इस आवेदन प्रपत्र में मात्र खंड 'B' के बिंदुओं को ही भरा जाएगा।<br />
                            </div>
                            ...
                            <table>
                                ...
                                <tr>
                                    ...
                                    <td colspan="4"><%# Eval("BSEB_Unique_ID") %></td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td><span><%# Eval("MatricBoardName") %></span></td>
                                </tr>
                            </table>
                            <table class="tbl-2">
                                <tr>
        ...
        <input type="checkbox" <%# Eval("Religion").ToString() == "OTHERS" ? "checked" : "" %> />
                        ...
                        <div class="page form-container" id="page2">
                            ...
                            <div class="section">
                                ...
                                <div class="input-row">
                                    <label>20. Appar Id * </label>

                                    <div class="digit-boxes">
                                        <span class="digit-box"><%--<%# Eval("ApaarId").ToString().Length > 0 ? Eval("ApaarId").ToString().Substring(0,1) : "" %>--%></span>
                                        <span class="digit-box"><%--<%# Eval("ApaarId").ToString().Length > 1 ? Eval("ApaarId").ToString().Substring(1,1) : "" %>--%></span>
                                        <span class="digit-box"><%--<%# Eval("ApaarId").ToString().Length > 2 ? Eval("ApaarId").ToString().Substring(2,1) : "" %>--%></span>
                                        <span class="digit-box"><%--<%# Eval("ApaarId").ToString().Length > 3 ? Eval("ApaarId").ToString().Substring(3,1) : "" %>--%></span>
                                        <span class="digit-box"><%--<%# Eval("ApaarId").ToString().Length > 4 ? Eval("ApaarId").ToString().Substring(4,1) : "" %>--%></span>
                                        <span class="digit-box"><%--<%# Eval("ApaarId").ToString().Length > 5 ? Eval("ApaarId").ToString().Substring(5,1) : "" %>--%></span>
                                        <span class="digit-box"><%--<%# Eval("ApaarId").ToString().Length > 6 ? Eval("ApaarId").ToString().Substring(6,1) : "" %>--%></span>
                                        <span class="digit-box"><%--<%# Eval("ApaarId").ToString().Length > 7 ? Eval("ApaarId").ToString().Substring(7,1) : "" %>--%></span>
                                        <span class="digit-box"><%--<%# Eval("ApaarId").ToString().Length > 8 ? Eval("ApaarId").ToString().Substring(8,1) : "" %>--%></span>
                                        <span class="digit-box"><%--<%# Eval("ApaarId").ToString().Length > 9 ? Eval("ApaarId").ToString().Substring(9,1) : "" %>--%></span>
                                        <span class="digit-box"><%--<%# Eval("ApaarId").ToString().Length > 10 ? Eval("ApaarId").ToString().Substring(10,1) : "" %>--%></span>
                                        <span class="digit-box"><%--<%# Eval("ApaarId").ToString().Length > 11 ? Eval("ApaarId").ToString().Substring(11,1) : "" %>--%></span>
                                    </div>
                                </div>
                                <div class="input-row">
                                    <label style="width: 330px;">21. Area where the institution is situated <strong>(कृपया ✓ करें)</strong></label>
                                ...
                                <div class="input-row">
                                    <label>22. Sub-Division (where the institution is situated)</label>
                                    <div class="subdivision-row">
                                ...
                                <div class="input-row">
                                    <label>32. Bank & Branch Name*</label>
                                ...
                                <div class="input-row">
                                    <label>33. Two identification marks of student</label>
                                    <div>
                                        i.
                                ...
                                <div class="input-row">
                                    <label style="width: 580px;">
                                        34. Medium (language) of appearing in examination (परीक्षा में उपस्थित होने का माध्यम) (Please tick √)</label>
                                    <div class="subdivision-row">
                    ...
                    <div class="page" id="pagewrap">
                        <div class="form-container">
                            <div class="section-title" style="padding-left: 5px;"><strong>35. Subject details with their numerical codes:-</strong></div>
                            <div class="page" id="page3">
                                <div class="q33-box">


                                    <div class="section-title" style="text-align: center; border: 1px solid black">
                                            ...
                                            <ItemTemplate>
                                                <tr>
                                                    ...
                                                    <td style="border-right: 1px solid #ccc; padding-right: 10px;">
                                                        <%# !string.IsNullOrEmpty(Eval("Group1SubjectName").ToString()) ? 
            string.Format("{0} <input type='checkbox' />", Eval("Group1SubjectCode")) : "" %>
                                                    </td>
                                                    ...
                                                    <td>
                                                        <%# !string.IsNullOrEmpty(Eval("Group2SubjectName").ToString()) ? 
            string.Format("{0} <input type='checkbox' />", Eval("Group2SubjectCode")) : "" %>
                                                    </td>
                                                </tr>
                                            </ItemTemplate>
                                        </asp:Repeater>
                                ...
                                <div class="q33-box">
                                    ...
                                    <table>
                                        <asp:Repeater ID="rptElectiveSubjects" runat="server" Visible="true">
                                            <ItemTemplate>
                                                <tr>
                                                    <td><%# Eval("Name1") %></td>
                                                    <td>
                                                        <%# !string.IsNullOrEmpty(Eval("Name1").ToString()) ? 
                                                        String.Format("<span>{0}</span> <input type='checkbox' />", Eval("Code1")) : "" %>
                                                    </td>
                                                    <td><%# Eval("Name2") %></td>
                                                    <td>
                                                        <%# !string.IsNullOrEmpty(Eval("Name2").ToString()) ? 
                                                        String.Format("<span>{0}</span> <input type='checkbox' />", Eval("Code2")) : "" %>
                                                    </td>
                                                </tr>
                                            </ItemTemplate>
                                        </asp:Repeater>
                                        ...
                                        <ItemTemplate>
                                            <tr>
                                                ...
                                                <td>
                                                    <%# Eval("SubjectName").ToString().ToLower() == "common" ? String.Format("{0}, {1}", Eval("Code1"), Eval("Code2")): String.Format("{0} <input type='checkbox' />", Eval("Code1")) %>
                                                </td>
                                        ...
                                        <asp:Repeater ID="rptAdditionalSubjects" runat="server">
                                            <ItemTemplate>
                                                <tr>
                                                    <%-- Column 1 --%>
                                                    <td><%# Eval("Name1") %></td>
                                                    <td><%# !string.IsNullOrEmpty(Eval("Name1").ToString()) 
                                            ? Eval("Code1") + " <input type='checkbox' />" : "" %></td>

                                                    <%-- Column 2 --%>
                                                    <td><%# Eval("Name2") %></td>
                                                    <td>
                                                        <%# !string.IsNullOrEmpty(Eval("Name2").ToString()) 
        ? Eval("Code2") + " <input type='checkbox' />" : "" %>
                                                    </td>

                                                    <%-- Column 3 --%>
                                                    <td><%# Eval("Name3") %></td>
                                                    <td><%# !string.IsNullOrEmpty(Eval("Name3").ToString()) 
                                            ?  Eval("Code3") + " <input type='checkbox' />" : "" %></td>
                                                </tr>
                                            </ItemTemplate>
                                        </asp:Repeater>
                                    </table>
                            ...
                            <div class="form-container" >
                                ...
                                <asp:Panel ID="pnlVocational" runat="server" Visible="false">
                                    <div class="q33-box">
                                        ...
                                        <h3>(For students of Science, Commerce & Arts faculties)
                                        </h3>

                                        <div class="instructions">
                                            (i)  विज्ञान, वाणिज्य एवं कला संकायों के विद्यार्थियों के लिए सत्र 2022–24 से राज्य के सभी जिलों के कुछ चिन्हित +2 विद्यालय/महाविद्यालयों में विभिन्न व्यावसायिक ट्रेड के पठन–पाठन की शुरुआत की गई है, जिसकी सूची समिति के पोर्टल/वेबसाइट पर प्रदर्शित की गई है। व्यावसायिक ट्रेड का पठन–पाठन अनिवार्य (Compulsory), ऐच्छिक (Elective) तथा अतिरिक्त (Additional) विषय संरचना के अलावे होगा।<br>
                                            (ii) उपरोक्त +2 विद्यालयों, जिनकी सूची समिति के पोर्टल/वेबसाइट पर प्रदर्शित की गई है, के वैसे विद्यार्थियों, जिन्हें व्यावसायिक ट्रेड आवंटित किया गया है, के द्वारा इस ट्रेड समूह में से किसी एक ट्रेड का चयन किया जाना एवं उसकी परीक्षा (सैद्धान्तिक एवं प्रायोगिक) में उत्तीर्ण होना अनिवार्य है। यद्यपि कि, इसके प्राप्तांक की गणना श्रेणी निर्धारण हेतु नहीं की जाएगी तथा इसे किसी अन्य विषय के प्राप्तांक से परिवर्तित (Interchange/Swap) नहीं किया जाएगा।<br>
                                            (iii) राज्य/जिला के अन्य +2 विद्यालय, जो व्यावसायिक ट्रेड के पठन–पाठन हेतु चिन्हित नहीं हैं, के विद्यार्थियों द्वारा इस ट्रेड समूह में से किसी भी ट्रेड का चयन नहीं किया जाएगा।                                       
                                        </div>
...
function updateAndPrint() {
    ...
    if (studentData) {
        ...
        $.ajax({
            type: "POST",
            url: "InterRegistrationForm.aspx/UpdateDownloaded",
            data: JSON.stringify({ studentData: studentData }),
            contentType: "application/json; charset=utf-8",
            dataType: "json",
            success: function (response) {
                console.log("Update result:", response.d);
                // After DB update, call print
                window.print();
            },
            error: function (xhr, status, error) {
                console.error("Error updating:", error);
                window.print(); // still allow print even if update fails
            }
        });
    } else {
        window.print();
