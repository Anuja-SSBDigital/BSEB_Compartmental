                ...
                <div class="mt-2">
                    ...
                    <div class="" style="font-family: 'Noto Sans Devanagari', 'Mangal', 'Arial', sans-serif; font-size: 17px; margin-top: 25px;">
                        ...
                        <ol style='<%# Eval("FacultyName").ToString() == "SCIENCE" ? "font-size: 14px;": "font-size: 16px;" %>'>
                            ...
                            <li>परीक्षार्थी अपनी उत्तरपुस्तिका के कवर पृष्ठ के ऊपरी बायें तथा दायें भागों में क्रमांक-(1) में अपने उत्तर देने का माध्यम अंकित करते हुए क्रमांक-(2) में अपना पूर्ण हस्ताक्षर अंकित करें। इसके अलावा अन्य मुद्रित विवरणों में किसी भी प्रकार से कोई छेड़-छाड़ नहीं करेंगे।</li>
