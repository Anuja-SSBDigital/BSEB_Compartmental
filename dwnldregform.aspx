<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="dwnldregform.aspx.cs" Inherits="dwnldregform" %>
                ...
                <div class="card-body">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <asp:DropDownList runat="server" class="form-control" ID="dr_session">
                                    <asp:ListItem Selected>2025-2027</asp:ListItem>
                                </asp:DropDownList>
                            </div>
                        </div>
                        <div class="col-md-6">
                    ...
                    <div class="text-center">
                        <strong><span id="SpSearchresult" runat="server" visible="false">Search Result For: </span>
                            <asp:Label runat="server" ID="lblCollege"></asp:Label>
                        </strong>
                    </div>
                            ...
                            <table class="table table-hover table-bordered dataTable" id="dataTable">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="form-col">Student Name</th>
                                        <th class="form-col">Father Name</th>
                                        <th class="form-col">Mother Name</th>
                                        <th class="form-col">DOB</th>
                                        <th class="form-col" style="width: 10%;">Form Downloaded</th>
                                    </tr>
                                </thead>
                                <tbody id="tableBody">
                                    <asp:Repeater runat="server" ID="rptStudents" EnableViewState="false" ClientIDMode="Static">
                                        <itemtemplate>
                                            <tr data-visible="true">
                                                ...
                                                <td><%# Eval("FormDownloaded").ToString().ToUpper() == "YES" || Eval("FormDownloaded").ToString() == "True" ? "YES" : "NO" %></td>
                                            </tr>
                                        </itemtemplate>
                                    </asp:Repeater>
                                </tbody>
