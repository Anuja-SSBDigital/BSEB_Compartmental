<%@ Page Language="C#" AutoEventWireup="true" CodeFile="arts.aspx.cs" Inherits="arts" %>
...
<body>
    ...
    <div class="container" id="pagewrap">
        ...
        <div class="section">
          ...
          <div class="q33-box">
        <div class="section-title">33. Subject details with their numerical codes:-</div>
        ...
        <table>
            ...
            <tr>
                <td>English</td>
                <td class="checkbox-cell">305
                    <input type="checkbox"></td>
                <td>Magahi</td>
                <td class="checkbox-cell">311
                    <input type="checkbox"></td>
            </tr>
            <tr>
                <td>Hindi</td>
                <td class="checkbox-cell">306
                    <input type="checkbox"></td>
                <td>Bhojpuri</td>
                <td class="checkbox-cell">312
                    <input type="checkbox"></td>
            </tr>
            <tr>
                <td>Urdu</td>
                <td class="checkbox-cell">307
                    <input type="checkbox"></td>
                <td>Arabic</td>
                <td class="checkbox-cell">313
                    <input type="checkbox"></td>
            </tr>
            <tr>
                <td>Maithili</td>
                <td class="checkbox-cell">308
                    <input type="checkbox"></td>
                <td>Persian</td>
                <td class="checkbox-cell">314
                    <input type="checkbox"></td>
            </tr>
            <tr>
                <td>Sanskrit</td>
                <td class="checkbox-cell">309
                    <input type="checkbox"></td>
                <td>Pali</td>
                <td class="checkbox-cell">315
                    <input type="checkbox"></td>
            </tr>
            <tr>
                <td>Prakrit</td>
                <td class="checkbox-cell">310
                    <input type="checkbox"></td>
                <td>Bangla</td>
                <td class="checkbox-cell">316
                    <input type="checkbox"></td>
            </tr>
        </table>
              </div>
        ...
        <table>
            <tr>
                <td>Music</td>
                <td class="checkbox-cell">318
                    <input type="checkbox"></td>
                <td>Geography</td>
                <td class="checkbox-cell">323
                    <input type="checkbox"></td>
            </tr>
            <tr>
                <td>Home Science</td>
                <td class="checkbox-cell">319
                    <input type="checkbox"></td>
                <td>Psychology</td>
                <td class="checkbox-cell">324
                    <input type="checkbox"></td>
            </tr>
            <tr>
                <td>Philosophy</td>
                <td class="checkbox-cell">320
                    <input type="checkbox"></td>
                <td>Sociology</td>
                <td class="checkbox-cell">325
                    <input type="checkbox"></td>
            </tr>
            <tr>
                <td>History</td>
                <td class="checkbox-cell">321
                    <input type="checkbox"></td>
                <td>Economics</td>
                <td class="checkbox-cell">326
                    <input type="checkbox"></td>
            </tr>
            <tr>
                <td>Political Science</td>
                <td class="checkbox-cell">322
                    <input type="checkbox"></td>
                <td>Mathematics</td>
                <td class="checkbox-cell">327
                    <input type="checkbox"></td>
            </tr>
        </table>
             </div>
        ...
        <table>
            <tr>
                <td>Yoga & Phy. Edu.</td>
                <td class="checkbox-cell">317
                    <input type="checkbox"></td>
                <td>Economics</td>
                <td class="checkbox-cell">326
                    <input type="checkbox"></td>
                <td>Prakrit</td>
                <td class="checkbox-cell">335
                    <input type="checkbox"></td>
            </tr>
            <tr>
                <td>Music</td>
            ...
            <tr>
                ...
                <td class="checkbox-cell">328
                    <input type="checkbox"></td>
                <td>Bhojpuri</td>
                <td class="checkbox-cell">337
                    <input type="checkbox"></td>
            </tr>
            <tr>
                <td>Philosophy</td>
                ...
                <td class="checkbox-cell">329
                    <input type="checkbox"></td>
                <td>Arabic</td>
                <td class="checkbox-cell">338
                    <input type="checkbox"></td>
            </tr>
            <tr>
                <td>History</td>
                <td class="checkbox-cell">321
                    <input type="checkbox"></td>
                <td>English</td>
                <td class="checkbox-cell">330
                    <input type="checkbox"></td>
                <td>Persian</td>
                <td class="checkbox-cell">339
                    <input type="checkbox"></td>
            </tr>
            <tr>
                <td>Political Science</td>
                <td class="checkbox-cell">322
                    <input type="checkbox"></td>
                <td>Hindi</td>
                <td class="checkbox-cell">331
                    <input type="checkbox"></td>
                <td>Pali</td>
                <td class="checkbox-cell">340
                    <input type="checkbox"></td>
            </tr>
            <tr>
                <td>Geography</td>
                <td class="checkbox-cell">323
                    <input type="checkbox"></td>
                <td>Urdu</td>
                <td class="checkbox-cell">332
                    <input type="checkbox"></td>
                <td>Bangla</td>
                <td class="checkbox-cell">341
                    <input type="checkbox"></td>
            </tr>
            <tr>
                <td>Psychology</td>
        ...
        <table class="voc-table">
            ...
            <tr>
                ...
                <td class="checkbox-cell">
                    <input type="checkbox"></td>
                <td class="subject-label">Electronics &amp; H/W</td>
                <td class="code">347 / 347 HW</td>
                <td class="checkbox-cell">
                    <input type="checkbox"></td>
            </tr>
            <tr>
                <td class="subject-label">Beauty &amp; Wellness</td>
                <td class="code">348</td>
                <td class="checkbox-cell">
                    <input type="checkbox"></td>
                <td class="subject-label">Telecom</td>
                <td class="code">349</td>
                <td class="checkbox-cell">
                    <input type="checkbox"></td>
