<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CompExaminationForm.aspx.cs" Inherits="CompExaminationForm" %>
...
<body>
    <form id="form1" runat="server">
        <div class="print-btn-container" style="text-align: center !important; margin-bottom: 10px;">
            ...
            <a href="DwnldComExamForm.aspx" class="btn btn-primary no-print" id="btnback" style="text-decoration: none !important;">Back</a>
