...
public partial class CompartmentalExaminationForm : System.Web.UI.Page
{
    private static readonly log4net.ILog log = log4net.LogManager.GetLogger(typeof(CompartmentalExaminationForm));
